...
<head>
    ...
    <title>ShopEase - Special Sale & Clearance</title>
    ...
    <section class="hero-section relative h-[350px] flex items-center">
        <div class="container mx-auto px-4 relative z-10">
            <div class="max-w-lg text-white">
                ...
                <h1 class="text-4xl md:text-5xl font-bold mb-4">The Special Sale</h1>
                <p class="text-lg text-gray-200 mb-8 font-medium">
                    Up to 50% off on premium seasonal drops. Explore our limited-time clearance items, apparel, and active footwear before they sell out.
                </p>
            </div>
        </div>
    </section>
    ...
    <section id="shop-grid" class="py-16">
                ...
                <div class="flex flex-wrap items-center justify-between gap-4 mb-8 pb-4 border-b border-gray-100 md:hidden">
                    ...
                    <div class="flex items-center space-x-2">
                        ...
                        <select id="mobile-sort" name="sort"
                            ...
                            <option value="newest" {{ request('sort') == 'newest' ? 'selected' : '' }}>Discount Level</option>
                        </select>
                    </div>
                </div>
                ...
                <div class="flex flex-col md:flex-row gap-8">
                    ...
                    <aside id="sidebarFilter" class="hidden md:block w-full md:w-64 flex-shrink-0 space-y-8 bg-white z-20">
                        ...
                        <div>
                            ...
                            <div class="relative">
                                <input type="text" name="search" value="{{ request('search') }}" placeholder="Search sale items..."
                        ...
                        <div>
                            ...
                            <div class="space-y-3">
                                <label class="custom-checkbox block pl-7 text-sm text-gray-700">
                                    <input type="checkbox" name="discount_levels[]" value="50_plus" {{ in_array('50_plus', request('discount_levels', [])) ? 'checked' : '' }} />
                                    <span class="checkmark"></span>
                                    50% Off & More
                                </label>
                                <label class="custom-checkbox block pl-7 text-sm text-gray-700">
                                    <input type="checkbox" name="discount_levels[]" value="30_50" {{ in_array('30_50', request('discount_levels', [])) ? 'checked' : '' }} />
                                    <span class="checkmark"></span>
                                    30% - 50% Off
                                </label>
                                <label class="custom-checkbox block pl-7 text-sm text-gray-700">
                                    <input type="checkbox" name="discount_levels[]" value="under_30" {{ in_array('under_30', request('discount_levels', [])) ? 'checked' : '' }} />
                                    <span class="checkmark"></span>
                                    Up to 30% Off
                                </label>
                            </div>
                        ...
                        <div>
                            ...
                            <div class="space-y-3">
                                <label class="custom-checkbox block pl-7 text-sm text-gray-700">
                                    <input type="checkbox" name="categories[]" value="womens-apparel" {{ in_array('womens-apparel', request('categories', [])) ? 'checked' : '' }} />
                                    <span class="checkmark"></span>
                                    Women's Apparel
                                </label>
                                <label class="custom-checkbox block pl-7 text-sm text-gray-700">
                                    <input type="checkbox" name="categories[]" value="mens-apparel" {{ in_array('mens-apparel', request('categories', [])) ? 'checked' : '' }} />
                                    <span class="checkmark"></span>
                                    Men's Apparel
                                </label>
                                <label class="custom-checkbox block pl-7 text-sm text-gray-700">
                                    <input type="checkbox" name="categories[]" value="footwear" {{ in_array('footwear', request('categories', [])) ? 'checked' : '' }} />
                                    <span class="checkmark"></span>
                                    Footwear
                                </label>
                                <label class="custom-checkbox block pl-7 text-sm text-gray-700">
                                    <input type="checkbox" name="categories[]" value="accessories" {{ in_array('accessories', request('categories', [])) ? 'checked' : '' }} />
                                    <span class="checkmark"></span>
                                    Accessories
                                </label>
                            </div>
                    ...
                    <div class="flex-1">
                        ...
                        <div class="hidden md:flex justify-between items-center mb-8">
                            <p class="text-gray-500 text-sm">
                                ...
                                <span class="font-medium text-gray-900">{{ $products->total() }}</span> clearance products
                            </p>
                            <div class="flex items-center space-x-4">
                                ...
                                <select name="sort" id="desktop-sort"
                                    ...
                                    <option value="price_low_high" {{ request('sort') == 'price_low_high' ? 'selected' : '' }}>Price: Low to High</option>
                                    <option value="price_high_low" {{ request('sort') == 'price_high_low' ? 'selected' : '' }}>Price: High to Low</option>
                                    <option value="newest" {{ request('sort') == 'newest' ? 'selected' : '' }}>Highest Discount</option>
                                </select>
                            </div>
                        </div>
                                    ...
                                    <div class="absolute top-3 left-3 z-10">
                                        @if($product->stock <= 0)
                                            ...
                                            <span class="bg-red-500 text-white text-xs px-2 py-1 rounded">
                                                {{ $product->discount_percentage ?? 'Sale' }}% Off
                                            </span>
        ...
        {{ in_array($product->id, $wishlistIds ?? []) ? 'text-rose-500' : 'text-gray-900 hover:text-rose-500' }}"
                            ...
                            <div class="col-span-3 text-center py-10 text-gray-500">
                                <h3 class="text-xl font-semibold">No Sale Products Available matching your search.</h3>
                            </div>
                            @endforelse
                        </div>
