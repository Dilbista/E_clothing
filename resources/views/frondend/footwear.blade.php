...
<body class="bg-white">
                ...
                <aside id="sidebarFilter" class="hidden md:block w-full md:w-64 flex-shrink-0 space-y-8">
                    ...
                    <div>
                        ...
                        <div class="grid grid-cols-4 gap-2">
                            <button class="py-2 border border-gray-200 text-sm rounded font-medium hover:border-primary hover:text-primary transition">37</button>
                            <button class="py-2 border border-gray-200 text-sm rounded font-medium hover:border-primary hover:text-primary transition">38</button>
                            <button class="py-2 border border-gray-200 text-sm rounded font-medium hover:border-primary hover:text-primary transition">39</button>
                            <button class="py-2 border border-primary text-sm rounded font-medium text-primary bg-primary/5 transition">40</button>
                            <button class="py-2 border border-gray-200 text-sm rounded font-medium hover:border-primary hover:text-primary transition">41</button>
                            <button class="py-2 border border-gray-200 text-sm rounded font-medium hover:border-primary hover:text-primary transition">42</button>
                            <button class="py-2 border border-gray-200 text-sm rounded font-medium hover:border-primary hover:text-primary transition">43</button>
                            <button class="py-2 border border-gray-200 text-sm rounded font-medium hover:border-primary hover:text-primary transition">44</button>
                        </div>
                    </div>
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
                        ...
                        <div class="group">
                            <div class="relative overflow-hidden rounded-lg mb-4">
                                <!-- Single status badge block (duplicate removed) -->
    ...
    {{ in_array($product->id, $wishlistIds ?? []) ? 'text-rose-500' : 'text-gray-900 hover:text-rose-500' }}"
                        ...
                        @empty
                        <div class="col-span-3 text-center py-10">No footwear products found.</div>
                        @endforelse
                    </div>
