        ...
        <div class="container mx-auto px-4 relative z-10">
            <div class="max-w-lg text-white">
                ...
                <p class="text-lg text-gray-200 mb-8 font-medium">
                    Step into style. Discover premium-crafted leather boots, contemporary dress shoes, everyday
                    sneakers, and lightweight summer sandals.
                </p>
            </div>
        </div>
    </section>
            ...
            <div class="flex flex-col md:flex-row gap-8">
                ...
                <aside id="sidebarFilter" class="hidden md:block w-full md:w-64 flex-shrink-0 space-y-8">
                    ...
                    <div>
                        ...
                        <div class="space-y-4">
                            <input type="range" min="30" max="400" value="200" class="custom-range" id="priceRange" />
                            <div class="flex items-center justify-between text-sm text-gray-600">
                                <span>Min: Rs.30</span>
                                <span class="font-semibold text-primary" id="priceVal">Max: Rs.200</span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        <div class="grid grid-cols-4 gap-2">
                            <button
                                class="py-2 border border-gray-200 text-sm rounded font-medium hover:border-primary hover:text-primary transition">37</button>
                            <button
                                class="py-2 border border-gray-200 text-sm rounded font-medium hover:border-primary hover:text-primary transition">38</button>
                            <button
                                class="py-2 border border-gray-200 text-sm rounded font-medium hover:border-primary hover:text-primary transition">39</button>
                            <button
                                class="py-2 border border-primary text-sm rounded font-medium text-primary bg-primary/5 transition">40</button>
                            <button
                                class="py-2 border border-gray-200 text-sm rounded font-medium hover:border-primary hover:text-primary transition">41</button>
                            <button
                                class="py-2 border border-gray-200 text-sm rounded font-medium hover:border-primary hover:text-primary transition">42</button>
                            <button
                                class="py-2 border border-gray-200 text-sm rounded font-medium hover:border-primary hover:text-primary transition">43</button>
                            <button
                                class="py-2 border border-gray-200 text-sm rounded font-medium hover:border-primary hover:text-primary transition">44</button>
                        </div>
                    </div>
                ...
                <div class="flex-1">
                    ...
                    <div class="hidden md:flex justify-between items-center mb-8">
                        <p class="text-gray-500 text-sm">Showing <span class="font-medium text-gray-900">1 - 6</span> of
                            <span class="font-medium text-gray-900">36</span> products
                        </p>
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
                        <!-- Product 1: Premium White Sneakers -->
                        <div class="group">
                        ...
                        <div class="group">
                            <div class="relative overflow-hidden rounded-lg mb-4">
                                ...
                                <img src="https://images.unsplash.com/photo-1638247025967-b4e38f68931a?auto=format&fit=crop&w=500&h=600&q=80"
                                    alt="Suede Boots" class="w-full h-80 object-cover object-center" />
                                <div
                                    class="absolute inset-0 bg-black/5 opacity-0 group-hover:opacity-100 transition-opacity flex items-center justify-center">
                                    <button
                                        class="bg-white text-gray-900 w-10 h-10 rounded-full flex items-center justify-center shadow-md mx-1 hover:bg-gray-100 transition">
                            ...
                            <div>
                                <h3 class="font-medium text-gray-900 mb-1">Classic Suede Chelsea Boots</h3>
                                <div class="flex items-center mb-1">
                                    <div class="flex text-amber-400 text-sm">
                                        <i class="ri-star-fill"></i>
                                        <i class="ri-star-fill"></i>
                        ...
                        <!-- Product 3: Leather Dress Shoes -->
                        <div class="group">
                            <div class="relative overflow-hidden rounded-lg mb-4">
                                <span
                                    class="absolute top-3 left-3 bg-primary text-white text-xs px-2 py-1 rounded">New</span>
                                <img src="https://images.unsplash.com/photo-1614252235316-8c857d38b5f4?auto=format&fit=crop&w=500&h=600&q=80"
                                    alt="Dress Shoes" class="w-full h-80 object-cover object-center" />
                                <div
                                    class="absolute inset-0 bg-black/5 opacity-0 group-hover:opacity-100 transition-opacity flex items-center justify-center">
                                    <button
                                        class="bg-white text-gray-900 w-10 h-10 rounded-full flex items-center justify-center shadow-md mx-1 hover:bg-gray-100 transition">
                            ...
                            <div>
                                <h3 class="font-medium text-gray-900 mb-1">Premium Leather Dress Shoes</h3>
                                <div class="flex items-center mb-1">
                                    <div class="flex text-amber-400 text-sm">
                                        <i class="ri-star-fill"></i>
                                        <i class="ri-star-fill"></i>
                                ...
                                <p class="text-gray-900 font-medium">Rs.179.99</p>
                            </div>
                        </div>

                        <!-- Product 4: Elegant Heels -->
                        <div class="group">
                            <div class="relative overflow-hidden rounded-lg mb-4">
                                <img src="https://images.unsplash.com/photo-1543163521-1bf539c55dd2?auto=format&fit=crop&w=500&h=600&q=80"
                                    alt="Heels" class="w-full h-80 object-cover object-center" />
                                <div
                                    class="absolute inset-0 bg-black/5 opacity-0 group-hover:opacity-100 transition-opacity flex items-center justify-center">
                                    <button
                                        class="bg-white text-gray-900 w-10 h-10 rounded-full flex items-center justify-center shadow-md mx-1 hover:bg-gray-100 transition">
                            ...
                            <div>
                                <h3 class="font-medium text-gray-900 mb-1">Elegant Stiletto Heels</h3>
                                <div class="flex items-center mb-1">
                                    <div class="flex text-amber-400 text-sm">
                                        <i class="ri-star-fill"></i>
                                        <i class="ri-star-fill"></i>
                        ...
                        <!-- Product 5: Suede Loafers -->
                        <div class="group">
                            <div class="relative overflow-hidden rounded-lg mb-4">
                                <img src="https://images.unsplash.com/photo-1533867617858-e7b97e060509?auto=format&fit=crop&w=500&h=600&q=80"
                                    alt="Loafers" class="w-full h-80 object-cover object-center" />
                                <div
                                    class="absolute inset-0 bg-black/5 opacity-0 group-hover:opacity-100 transition-opacity flex items-center justify-center">
                                    <button
                                        class="bg-white text-gray-900 w-10 h-10 rounded-full flex items-center justify-center shadow-md mx-1 hover:bg-gray-100 transition">
                            ...
                            <div>
                                <h3 class="font-medium text-gray-900 mb-1">Casual Suede Loafers</h3>
                                <div class="flex items-center mb-1">
                                    <div class="flex text-amber-400 text-sm">
                                        <i class="ri-star-fill"></i>
                                        <i class="ri-star-fill"></i>
                                    ...
                                    <span class="text-xs text-gray-500 ml-1">(22)</span>
                                </div>
                                <p class="text-gray-900 font-medium">Rs.99.99</p>
                            </div>
                        </div>

                        <!-- Product 6: Summer Sandals -->
                        <div class="group">
                            <div class="relative overflow-hidden rounded-lg mb-4">
                                <span
                                    class="absolute top-3 left-3 bg-rose-500 text-white text-xs px-2 py-1 rounded">Sale</span>
                                <img src="https://images.unsplash.com/photo-1562273138-f46be4ebdf33?auto=format&fit=crop&w=500&h=600&q=80"
                                    alt="Sandals" class="w-full h-80 object-cover object-center" />
                                <div
                                    class="absolute inset-0 bg-black/5 opacity-0 group-hover:opacity-100 transition-opacity flex items-center justify-center">
                                    <button
                                        class="bg-white text-gray-900 w-10 h-10 rounded-full flex items-center justify-center shadow-md mx-1 hover:bg-gray-100 transition">
                            ...
                            <div>
                                <h3 class="font-medium text-gray-900 mb-1">Classic Leather Sandals</h3>
                                <div class="flex items-center mb-1">
                                    <div class="flex text-amber-400 text-sm">
                                        <i class="ri-star-fill"></i>
                                        <i class="ri-star-fill"></i>
                                    ...
                                    <span class="text-xs text-gray-500 ml-1">(15)</span>
                                </div>
                                <div class="flex items-center">
                                    <p class="text-gray-900 font-medium">Rs.49.99</p>
                                    <p class="text-gray-500 line-through text-sm ml-2">Rs.64.99</p>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8">
                ...
                <div>
                    ...
                    <ul class="space-y-3">
                        ...
                        <li>
                            <a href="#" class="text-primary font-medium transition-colors">Footwear</a>
                        </li>
                        <li>
