...
<head>
    ...
    <title>ShopEase - Premium Accessories</title>
...
<body class="bg-white">
    ...
    <section class="hero-section relative h-[350px] flex items-center">
        <div class="container mx-auto px-4 relative z-10">
            <div class="max-w-lg text-white">
                ...
                <h1 class="text-4xl md:text-5xl font-bold mb-4">Premium Accessories</h1>
    ...
    <section id="shop-grid" class="py-16">
                ...
                <div class="flex flex-col md:flex-row gap-8">
                    ...
                    <aside id="sidebarFilter" class="hidden md:block w-full md:w-64 flex-shrink-0 space-y-8 bg-white z-20">
                        ...
                        <!-- <div>
                            ...
                            <div class="space-y-3">
                                <label class="custom-checkbox block pl-7 text-sm text-gray-700">
                                    <input type="checkbox" name="categories[]" value="bags-wallets" {{ in_array('bags-wallets', request('categories', [])) ? 'checked' : '' }} />
                                    <span class="checkmark"></span>
                                    Bags & Wallets
                                </label>
                                <label class="custom-checkbox block pl-7 text-sm text-gray-700">
                                    <input type="checkbox" name="categories[]" value="watches" {{ in_array('watches', request('categories', [])) ? 'checked' : '' }} />
                                    <span class="checkmark"></span>
                                    Watches
                                </label>
                                <label class="custom-checkbox block pl-7 text-sm text-gray-700">
                                    <input type="checkbox" name="categories[]" value="sunglasses" {{ in_array('sunglasses', request('categories', [])) ? 'checked' : '' }} />
                                    <span class="checkmark"></span>
                                    Sunglasses
                                </label>
                                <label class="custom-checkbox block pl-7 text-sm text-gray-700">
                                    <input type="checkbox" name="categories[]" value="jewelry-chains" {{ in_array('jewelry-chains', request('categories', [])) ? 'checked' : '' }} />
                                    <span class="checkmark"></span>
                                    Jewelry & Chains
                                </label>
                                <label class="custom-checkbox block pl-7 text-sm text-gray-700">
                                    <input type="checkbox" name="categories[]" value="hats-belts-scarves" {{ in_array('hats-belts-scarves', request('categories', [])) ? 'checked' : '' }} />
                                    <span class="checkmark"></span>
                                    Hats, Belts & Scarves
                                </label>
                            </div>
                        ...
                        <div>
                            ...
                            <div class="space-y-4">
                                <input type="range" name="max_price" min="10" max="300000" value="{{ request('max_price', 300000) }}" class="custom-range" id="priceRange" />
                        ...
                        <!-- Availability (Radio Bind) -->
                        <div>
                            <h3 class="font-semibold text-gray-900 mb-4">Availability</h3>
                            <div class="grid grid-cols-2 gap-2">
                                <label class="cursor-pointer text-center">
                                    <input type="radio" name="availability" value="in_stock" class="sr-only peer" {{ request('availability', 'in_stock') == 'in_stock' ? 'checked' : '' }}>
                                ...
                                <label class="cursor-pointer text-center">
                                    <input type="radio" name="availability" value="pre_order" class="sr-only peer" {{ request('availability') == 'pre_order' ? 'checked' : '' }}>
                                    <div class="py-2 border border-gray-200 text-sm rounded font-medium transition hover:border-primary hover:text-primary peer-checked:border-primary peer-checked:text-primary peer-checked:bg-primary/5">
                                        Pre-Order
                                    </div>
                                </label>
        ...
        {{ in_array($product->id, $wishlistIds ?? []) ? 'text-rose-500' : 'text-gray-900 hover:text-rose-500' }}"
                            ...
                            @empty
                            <div class="col-span-3 text-center py-10 text-gray-500">No accessories found matching your search.</div>
                            @endforelse
                        </div>
    ...
    <script>
        ...
        if (filterForm) {
            // Automatically submit when checkboxes, radio options, or sorting drop-downs change
            filterForm.querySelectorAll('input[type="checkbox"], input[type="radio"], select').forEach(element => {
