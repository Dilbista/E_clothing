<header class="sticky top-0 z-50 bg-white shadow-sm">
    ...
    <nav class="hidden md:flex space-x-8">
      ...
      <div class="relative group">
        ...
        <div class="absolute left-0 mt-2 w-48 bg-white shadow-lg rounded hidden group-hover:block">
          <a href="#" class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-50">Women</a>
          <a href="#" class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-50">Men</a>
          <a href="#" class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-50">Accessories</a>
          <a href="#" class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-50">Footwear</a>
        </div>
      </div>
  ...
  <div id="mobileMenu" class="hidden md:hidden bg-white border-t border-gray-100">
    <div class="container mx-auto px-4 py-3 space-y-3">
      ...
      <div>
        <button id="mobileShopToggle" class="flex items-center justify-between w-full py-2 text-gray-900 font-medium">
          Shop
          <i class="ri-arrow-down-s-line"></i>
        </button>
