    ...
    <section id="shop-grid" class="py-16">
                ...
                <div class="flex flex-col md:flex-row gap-8">
                    ...
                    <aside id="sidebarFilter" class="hidden md:block w-full md:w-64 flex-shrink-0 space-y-8 bg-white z-20">
                        ...
                        <div>
                            ...
                            <div class="space-y-3">
                                <label class="custom-checkbox block pl-7 text-sm text-gray-700">
                                    <input type="checkbox" name="drop_window[]" value="this_week" {{ in_array('this_week', request('drop_window', [])) ? 'checked' : '' }} />
                                    <span class="checkmark"></span>
                                    This Week
                                </label>
                                <label class="custom-checkbox block pl-7 text-sm text-gray-700">
                                    <input type="checkbox" name="drop_window[]" value="last_14_days" {{ in_array('last_14_days', request('drop_window', [])) ? 'checked' : '' }} />
                                    <span class="checkmark"></span>
                                    Last 14 Days
                                </label>
                                <label class="custom-checkbox block pl-7 text-sm text-gray-700">
                                    <input type="checkbox" name="drop_window[]" value="last_30_days" {{ in_array('last_30_days', request('drop_window', [])) ? 'checked' : '' }} />
                                    <span class="checkmark"></span>
                                    Last 30 Days
                                </label>
                            </div>
                        ...
                        <div class="hidden md:flex justify-between items-center mb-8">
                            ...
                            <div class="flex items-center space-x-4">
                                ...
                                <select name="sort" id="desktop-sort"
                                    ...
                                    <option value="price_low_high" {{ request('sort') == 'price_low_high' ? 'selected' : '' }}>Price: Low to High</option>
                                    <option value="price_high_low" {{ request('sort') == 'price_high_low' ? 'selected' : '' }}>Price: High to Low</option>
                                    <option value="newest" {{ request('sort') == 'newest' ? 'selected' : '' }}>Newest Drop</option>
                                </select>
                            </div>
                        </div>
        ...
        {{ in_array($product->id, $wishlistIds ?? []) ? 'text-rose-500' : 'text-gray-900 hover:text-rose-500' }}"
                            ...
                            <div class="col-span-3 text-center py-10 text-gray-500">
                                <h3 class="text-xl font-semibold">No New Products Found matching your search.</h3>
                            </div>
                            @endforelse
                        </div>
