...
<body class="bg-white">
    ...
    <section class="hero-section relative h-[350px] flex items-center">
        <div class="container mx-auto px-4 relative z-10">
            <div class="max-w-lg text-white">
                ...
                <h1 class="text-4xl md:text-5xl font-bold mb-4">Men's <br> Collection </h1>
    ...
    <section id="shop-grid" class="py-16">
                ...
                <div class="flex flex-col md:flex-row gap-8">
                    ...
                    <aside id="sidebarFilter" class="hidden md:block w-full md:w-64 flex-shrink-0 space-y-8 bg-white z-20">
                        ...
                        <div>
                            ...
                            <div class="space-y-4">
                                <input type="range" name="max_price" min="15" max="300000" value="{{ request('max_price', 300000) }}" class="custom-range" id="priceRange" />
        ...
        {{ in_array($product->id, $wishlistIds ?? []) ? 'text-rose-500' : 'text-gray-900 hover:text-rose-500' }}"
                            ...
                            @empty
                            <div class="col-span-3 text-center py-10 text-gray-500">No men's products found matching your search.</div>
                            @endforelse
                        </div>
