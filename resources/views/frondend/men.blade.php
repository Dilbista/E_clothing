...
<body class="bg-white">
    ...
    <section class="hero-section relative h-[350px] flex items-center">
        <div class="container mx-auto px-4 relative z-10">
            <div class="max-w-lg text-white">
                ...
                <h1 class="text-4xl md:text-5xl font-bold mb-4">Men's Collection 2025</h1>
                <p class="text-lg text-gray-200 mb-8 font-medium">
                    Discover robust designs, refined tailoring, and modern casualwear. Crafted for lasting premium comfort and sophisticated style.
                </p>
            </div>
        </div>
    </section>
                ...
                <aside id="sidebarFilter" class="hidden md:block w-full md:w-64 flex-shrink-0 space-y-8">
                    ...
                    <div>
                        ...
                        <div class="grid grid-cols-4 gap-2">
                            <button class="py-2 border border-gray-200 text-sm rounded font-medium hover:border-primary hover:text-primary transition">S</button>
                            <button class="py-2 border border-primary text-sm rounded font-medium text-primary bg-primary/5 transition">M</button>
                            <button class="py-2 border border-gray-200 text-sm rounded font-medium hover:border-primary hover:text-primary transition">L</button>
                            <button class="py-2 border border-gray-200 text-sm rounded font-medium hover:border-primary hover:text-primary transition">XL</button>
                            <button class="py-2 border border-gray-200 text-sm rounded font-medium hover:border-primary hover:text-primary transition">XXL</button>
                        </div>
                    </div>
    ...
    {{ in_array($product->id, $wishlistIds ?? []) ? 'text-rose-500' : 'text-gray-900 hover:text-rose-500' }}"
                        ...
                        @empty
                        <div class="col-span-3 text-center py-10">No men's products found.</div>
                        @endforelse
                    </div>
